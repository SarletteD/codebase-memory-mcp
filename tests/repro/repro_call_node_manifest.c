...
enum {
    EXPECTED_HISTORICAL_CALL_NODE_TOTAL = 228,
    EXPECTED_ACTIVE_PRIMARY_TOTAL = 198,
    EXPECTED_DIRECT_CALLS = 162,
...
static const CallNodeManifestEntry CALL_NODE_MANIFEST[] = {
    ...
    ENTRY(CBM_LANG_ST, "call_expression", DIRECT_CALL, PRIMARY_EXTRACTOR, true, true),
    ENTRY(CBM_LANG_ST, "invocation_statement", DIRECT_CALL, PRIMARY_EXTRACTOR, true, true),
};
